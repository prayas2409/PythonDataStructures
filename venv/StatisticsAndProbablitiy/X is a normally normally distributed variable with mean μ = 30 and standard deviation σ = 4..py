...
print("The probability of area < 40 is ", normal_distributed_object.probability_x_more_than_21(21))
print("The probability of area < 40 is ", normal_distributed_object.probability_between_30_and_35(30,35))